...
def main():
    ...
    if 'gemini_model' not in st.session_state:
        ...
        if st.session_state.gemini_model is None:
            ...
            st.info("💡 Make sure you have created a `.env` file with your `GEMINI_API_KEY`")
            st.stop()
    ...
    with st.sidebar:
        ...
        <div class="sidebar-info">
            ...
            <ul>
                ...
                <li>Try queries like "When was Toyota founded?"</li>
                <li>Ask about specific models: "Tell me about Ford F-150"</li>
    ...
    <div style="text-align: center; color: #666; padding: 1rem;">
        ...
        <p><small>Real-time automotive information retrieval and AI-powered responses</small></p>
    </div>
    """, unsafe_allow_html=True)
